/*
 ...
 Source Schema         : makefoxbot_test

 Target Server Type    : MariaDB
 Target Server Version : 100523 (10.5.23-MariaDB)
 File Encoding         : 65001

 Date: 18/07/2024 23:25:10
*/
...
) ENGINE = InnoDB AUTO_INCREMENT = 23774 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for membership_prices
-- ----------------------------
...
CREATE TABLE `payment_sessions`  (
  ...
  `amount` decimal(10, 2) NULL DEFAULT NULL COMMENT 'Amount of transaction',
  ...
  `provider` enum('PAYPAL','STRIPE') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `provider_charge_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Charge or order ID from provider',
...
) ENGINE = InnoDB AUTO_INCREMENT = 25041 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 30306 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 19426 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
