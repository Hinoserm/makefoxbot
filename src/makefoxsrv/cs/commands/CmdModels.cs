...
namespace makefoxsrv.commands
{
    ...
    {
        [BotCommand(cmd: "model")]
        [CommandDescription("Select a different AI model")]
        public static async Task CmdSelectModel(FoxTelegram t, FoxUser user, TL.Message message)
        {
